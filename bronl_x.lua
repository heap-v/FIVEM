...
ALTab:AddSwitch("Shit AimLock", function(bool)
...
ALTab:AddSwitch("Silent Aim FOV Circle", function(bool)
    Aiming.ShowFOV = bool
end)
 
ALTab:AddSlider("Silent Aim FOV Size", function(value)
    Aiming.FOV = value
end, {
    ["min"] = 0,
    ["max"] = 400,
...
ALTab:AddSlider("Slient Aim Hitchance", function(value)
